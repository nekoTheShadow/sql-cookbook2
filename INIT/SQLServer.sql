...
WITH r (id) AS (SELECT 1 UNION ALL SELECT id + 1 FROM r WHERE id + 1 <= 1)   INSERT INTO T1   SELECT * FROM r OPTION (MAXRECURSION 500);
WITH r (id) AS (SELECT 1 UNION ALL SELECT id + 1 FROM r WHERE id + 1 <= 10)  INSERT INTO T10  SELECT * FROM r OPTION (MAXRECURSION 500);
WITH r (id) AS (SELECT 1 UNION ALL SELECT id + 1 FROM r WHERE id + 1 <= 100) INSERT INTO T100 SELECT * FROM r OPTION (MAXRECURSION 500);
WITH r (id) AS (SELECT 1 UNION ALL SELECT id + 1 FROM r WHERE id + 1 <= 500) INSERT INTO T500 SELECT * FROM r OPTION (MAXRECURSION 500);
